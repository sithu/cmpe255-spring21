...
if __name__ == '__main__':
    ...
    r_min= min([0, 0.0001, 0.001, 0.01, 0.1, 1, 10, 100, 1000], key=get_rmse)
    print("best value of regulaarization parameter is:",r_min)
    w0,w=carprice.train(r_min)
    y_pred=test(w0,w,df_test)
    print("Printing original msrp vs. predicted msrp of 5 cars") 
    carprice.display(df_test,y_test,y_pred)
    print("root mean square",carprice.rmse(y_test,y_pred))
